...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <!--  <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Admin <sup>05</sup></div>
            </a> -->
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3"> ALL<sup>Recipes</sup></div>
            </a>
            <li class="nav-item">
 ...
 -->
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar" style="">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="subcatlist.php">Sub-category list</a>
                    </div>
                </div>
            </li>
           ...
           <!--  <hr class="sidebar-divider"> -->
            ...
            <li class="nav-item">
                <a class="nav-link" href="recipelist.php">
                    <i class="fas fa-table"></i>
                    <span>Manage Recipes</span></a>
            </li>
